    ...
    <section className="adminPanel">
      ...
      <details className="adminDetails">
        ...
        <form action={saveExchangeAction} className="adminFormGrid">
          ...
          <input name="partnerUrl" placeholder="Реф. ссылка или параметр (ref=123 или https://site.com?ref=123)" />
          ...
          return (
            <article className="adminEditCard" key={exchange.id}>
              ...
              <form action={saveExchangeAction} className="adminFormGrid">
                ...
                <input name="partnerUrl" defaultValue={exchange.partnerUrl ?? ""} placeholder="Реф. ссылка или параметр (ref=123 или https://site.com?ref=123)" />
